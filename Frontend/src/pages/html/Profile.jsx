...
const Profile = () => {
  const [form, setForm] = useState({
    ...
    bio: "Full stack developer building hackathon tools. BCS-IT student focused on networking and cybersecurity.",
    github: "https://github.com/parash-dev",
    linkedin: "https://linkedin.com/in/parash",
    website: "",
  });
      ...
      <main className="dash_main">
        ...
        <div className="profile_grid">
          ...
          <div className="panel profile_side">
            ...
            <p className="profile_role">{form.role}</p>
            <span className="tag_leader profile_tag">Participant</span>

            <div className="profile_stats">
              <div className="profile_stat">
                <div className="profile_stat_value">3</div>
                <div className="profile_stat_label">Events</div>
              </div>
              <div className="profile_stat">
                <div className="profile_stat_value">2</div>
                <div className="profile_stat_label">Projects</div>
              </div>
              <div className="profile_stat">
                <div className="profile_stat_value">1</div>
                <div className="profile_stat_label">Wins</div>
              </div>
            </div>
